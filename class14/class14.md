...
```
    ...
    <bytecode: 0x10c1e60d0>
    <environment: 0x10c1d2930>
...
```
    ...
    Info: Working in directory /Users/sofiajaravata/Desktop/bimm143/bimm143_github/class14
...
The pathway Cell Cycle (p=2.64 E-5), hsa04110, has the most significant
“Entities p-value”. These most significant pathways match my previous
KEGG results, identifying cell cycle as one of the most significant
pathways alongside Cell Cycle, Mitotic (p=2.78 E-5). Some factors that
could cause differences are the databases that define pathways
differently, the genes included in each pathway, as well as the
